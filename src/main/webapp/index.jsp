...
<div class="list">
    <div class="container">
        <div class="row">
            <h1>Welcome to Astana IT University portal</h1>
            <h4 class="col-md-4">Astana IT University delivers digital transformation through teaching, research and successful innovation.
